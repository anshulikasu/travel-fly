    ...
    <div className="TandC">
      <div className="TandC_text">
        ...
        <p>
          ...
          conditions. Do not continue to use Flight hub deal if you do not agree
      ...
      <div className="TandC_one">
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By accessing Flight hub deal, you agreed
          to use cookies in agreement with the Flight hub deal's Privacy Policy.
      ...
      <div className="TandC_two">
        ...
        <p>
          ...
          Flight hub deal for your own personal use subjected to restrictions
        ...
        <p>
          ...
          Flight hub deal does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of Flight hub deal,its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their
          views and opinions. To the extent permitted by applicable laws, Flight
          hub deal shall not be liable for the Comments or for any liability,
        ...
        <p>
          Flight hub deal reserves the right to monitor all Comments and to
        ...
        <p>
          You hereby grant Flight hub deal a non-exclusive license to use,
      ...
      <p>
        ...
        intellectual property rights for all material on Flight hub deal. All
        intellectual property rights are reserved. You may access this from
        Flight hub deal for your own personal use subjected to restrictions set
      ...
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Flight hub deal does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Flight hub deal,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Flight hub deal
      ...
      <p>
        Flight hub deal reserves the right to monitor all Comments and to remove
      ...
      <p>
        ...
        the hyperlink compensates the absence of Flight hub deal; and (d) the
      ...
      <p>
        ...
        e-mail to Flight hub deal. Please include your name, your organization
